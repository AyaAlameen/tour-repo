        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="package-item bg-white mb-2">
                ...
                <div class="p-4">
                    ...
                    <br>
                    <a class="h5 text-decoration-none" href="">description</a>
                    <div class="border-top mt-4 pt-4">
                        <div class="d-flex justify-content-between align-items-baseline">
                            <h6 class="m-0">500.000 <small>spy</small></h6>
                            <h6><a class="btn btn-primary"  href="{{route('tripmore')}}" style="border-radius:3px;">more details for booking</a></h6>
                        </div>
                    </div>
                </div>
            </div>
