...
@section('content')
    ...
    <h4 class="p-5" style=" padding-bottom:5px !important;">اشهر الأماكن في
                    ...
                    <div class="mainCard  w-75 m-auto " style="border-radius: 10px;">
                        ...
                        @isset(Auth::user()->id)
                            <div class="w-100 pl-3 m-auto">
                                <img src="{{ asset(Auth::user()->image) }}" style="border-radius: 50%;  margin-right:4px;"
                        ...
                        @else
                            <div class="w-100 t pl-3 m-auto">
                                <img src="{{ asset('img/1656869576_personalimg.jpg') }}"
                                    style="border-radius: 50%;  margin-right:4px;" width="40px" height="40px">
                                <input type="text" style=" width: 77%;" placeholder="Leave a comment">
