                        ...
                        <div class="modal-body">
                            <table id="addTable" style="color: rgb(22, 22, 22); width: 400px;"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <i class="fas fa-plus text-body pt-2 pl-2" onclick="addPic()" id="add-pic-input" data-picid="1"
                                    ...
                                    <div class="modal-body">
                                        <table id="editTable"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <i class="fas fa-plus text-body pt-4 pl-2" onclick="editPic()" id="edit_pic_input" data-picid="1"
                                                        style="font-size:15px; float:left; cursor:pointer;"
                                                        title="Add Another Picture"></i>
