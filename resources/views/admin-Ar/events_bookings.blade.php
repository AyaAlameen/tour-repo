...
@section('admincontent')
    ...
    <div class="app-content">
        <div class="app-content-header" style="width: 72%;">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                            ...
                                                            @foreach ($events as $event)
                                                                <option style="cursor: pointer;"
                                                                    ...
                                                                    onclick="setService({{ $event->id }}, '{{ $event->translations()->where('locale', 'ar')->first()->name }} | {{$event->cost}}', 'service_{{ $event->id }}', {{$event->cost}})"
                                                                    href="#">
                                                                    {{ $event->translations()->where('locale', 'ar')->first()->name }} | {{$event->cost}}
                                                                </option>
                                                            @endforeach
        ...
        <div class="scroll-class" style="width:73%;">
            <div class="products-area-wrapper tableView">
                <div class="products-header">
                    ...
                    <div class="product-cell image ">كلفة الحجز</div>
...
<script>
    ...
    window.onload = (event) => {
        $.ajax({
                url: "{{ route('get_events_booking_ar') }}",
                type: "GET",
                processData: false,
                cache: false,
                contentType: false,
