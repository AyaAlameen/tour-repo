            ...
            <div class="app-content-actions-wrapper">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu border-0 rounded-0 m-0 toggle">
                        <a href="{{ route('getSubCategoriesAr', ['id' => $category->id]) }}" class="dropdown-item">
                            العربية</a>
                                            ...
                                            <form id="delete-form-{{ $subCategory->id }}" action="" method="POST"
                                                ...
                                                <div class="modal-body" style="direction:rtl;">
                                                    هل أنت متأكد من أنك تريد حذف هذا الصنف الفرعي (<span
                                                        style="color: #EB455F;">{{ $subCategory->translations()->where('locale', 'ar')->first()->name }}</span>)
                                                    ؟
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="action-button active close"
...
<script>
    ...
    function fields(formId, id) {
        ...
        $.ajax({
            ...
            .always(function() {
                // Re-enable the submit button and hide the loading spinner
                $("#fields-btn-" + id).attr("disabled", false).html('حفظ');
            });
    }
    //--------------------------------------------
</script>
