                            ...
                            <div class="modal-body">
                                <table style="color: rgb(22, 22, 22); width: 400px;"
                                    ...
                                    <tr>
                                        ...
                                        <td><input class="toggle text-primary in" type="number" name="carId" required
                                                style="width: 100%;"></td>
                                        <td>رقم السيارة</td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="text-end text-danger p-1"><span id="carId_error"></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    @foreach ($cities as $city)
                                                        <option style="cursor: pointer;" class="dropdown-item"
                                                            ...
                                                            onclick="setCity({{ $city->id }}, '{{ $city->translations()->where('locale', 'ar')->first()->name }}', 'city_{{ $city->id }}')"
                                                            href="#">
                                    ...
                                    <tr>
                                        ...
                                        <td><input class="toggle text-primary in" name="passengers_number" type="number"
            ...
            <div class="app-content-actions-wrapper">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu border-0 rounded-0 m-0 toggle">
                        <a href="{{ route('getTransportationsAr', ['id' => $company->id]) }}" class="dropdown-item">
                            العربية</a>
                        <a href="{{ route('getTransportationsEn', ['id' => $company->id]) }}"
                            class="dropdown-item">الانجليزية </a>
            ...
            <div id="transportations-data">
                ...
                @foreach ($transportations as $transportation)
                    <div class="products-row">
                        ...
                        <div class="product-cell">
                            <span> {{ $transportation->translations()->where('locale', 'ar')->first()->description }}
                            </span>
                        </div>
                        <div class="product-cell">
                            <!-- start action -->
                            <div class="p-3">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content" style="direction:ltr;">
                                                    ...
                                                    <table
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="dropdown toggle text-primary in"
                                                                    ...
                                                                    <span
                                                                        id="city-name-{{ $transportation->id }}">{{ $transportation->city->translations()->where('locale', 'ar')->first()->name }}</span>
                                                                    <div class="dropdown-menu"
                                                                        ...
                                                                        @foreach ($cities as $city)
                                                                            <option
                                                                                ...
                                                                                onclick="setEditCity({{ $city->id }}, {{ $transportation->id }}, '{{ $city->translations()->where('locale', 'ar')->first()->name }}', 'edit_city_{{ $transportation->id }}_{{ $city->id }}')"
                                                                                href="#">
                                                                                {{ $city->translations()->where('locale', 'ar')->first()->name }}
                                                                            </option>
                                                                        @endforeach
                                                        ...
                                                        <tr>
                                                            <td><input class="toggle text-primary in"
                                                                    ...
                                                                    value="{{ $transportation->translations()->where('locale', 'ar')->first()->description }}"
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit"
                                                    id="edit-transportation-btn-{{ $transportation->id }}"
                                                    onclick="editTransportation('edit-form-{{ $transportation->id }}', {{ $transportation->id }})"
                                ...
                                <a href="#" class="delete" data-toggle="modal"
                                    data-target="#deleteCompany{{ $transportation->id }}" title="Delete"
                                        ...
                                        <div class="modal-content" style="direction:ltr;">
                                            ...
                                            <form id="delete-form-{{ $transportation->id }}" action=""
                                                ...
                                                <div class="modal-body" style="direction:rtl;">
                                                    هل أنت متأكد من أنك تريد حذف وسيلة النقل ذات الرقم (<span
                                                        style="color: #EB455F;">{{ $transportation->carId }}</span>) ؟
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="action-button active close"
                                                        data-dismiss="modal">إغلاق</button>
                                                    <button type="submit"
                                                        id="delete-transportation-btn-{{ $transportation->id }}"
                                                        onclick="deleteTransportation(`delete-form-{{ $transportation->id }}`, {{ $transportation->id }})"
