                ...
                <div class="modal-dialog ">
                    <div class="modal-content toggle">
                        ...
                        <form id="add-form" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                <table style="width: 400px;"
                                    ...
                                    <tr>
                                        <td colspan="2" class="text-end text-danger"><span id="name_en_error"></span>
                                        </td>
                                    </tr>
                                    <tr>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" id="add-city-btn" onclick="addCity('add-form')"
        ...
        $.ajax({
            ...
            .fail(function(data) {
                ...
                if (data.responseJSON.errors.description) {
                    ...
                    document.querySelector(`#${formId} #des_error`).innerHTML = data.responseJSON.errors
                        .description[0];
