...
@section('admincontent')
    <div class="app-content">
        ...
        <div class="app-content-actions"  style="width: 95%">
            ...
            <div class="app-content-actions-wrapper">
                    ...
                    <div class="dropdown-menu border-0 rounded-0 m-0 toggle">
                        <a href="{{ route('emp-places-Ar') }}" class="dropdown-item"> العربية</a>
                        <a href="{{ route('emp-places-En') }}" class="dropdown-item">الانجليزية </a>
        ...
        <div class="products-area-wrapper tableView" style="direction: rtl;" id="employeesTable">
...
<script>
    ...
    window.onload = (event) => {
        $.ajax({
                url: "{{ route('getPlacesEmployeesAr') }}",
                type: "GET",
                processData: false,
                cache: false,
                contentType: false,
