                        ...
                        <div class="modal-body">
                            <table style="color: rgb(22, 22, 22); width: 400px;" id="addTable"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <i class="fas fa-plus text-body pt-2 pl-2" onclick="addPic()" id="add-pic-input"
                                            data-picid="1" style="font-size:15px; float:left; cursor:pointer;"
                                            title="Add Another Picture"></i>
                                        <input type="file" class="toggle text-primary in" name="event_image" required
                                    ...
                                    <div class="modal-body">
                                        <table class="table-striped table-hover table-bordered m-auto text-primary myTable"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <i class="fas fa-plus text-body pt-4 pl-2" onclick="editPic()"
