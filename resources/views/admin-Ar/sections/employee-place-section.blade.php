...
@foreach($employees as $employee)
    ...
    <div class="products-row">
       ...
       <div class="product-cell">{{$employee->permissions()->first()->pivot->place()->first()->translations()->where('locale', 'ar')->first()->name}}</div>
        <div class="product-cell">
     <!-- start action -->
<div class="p-3">
   <!-- edit -->
            ...
            <div class="dropdown toggle text-primary in"
                ...
                <div class="dropdown-menu"
                    ...
                    <input type="text"
                        ...
                        name="place_id"
                        value="{{ $employee->permissions()->first()->pivot->place_id }}" hidden>
