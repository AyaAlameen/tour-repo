  ...
  <div class="modal-content" style="direction:ltr;">
    ...
    <tr>
     ...
     <tr>
         ...
         <td ><textarea class="toggle text-primary in" type="text" name="address_ar" required style="width: 100%;">{{$employee->translations()->where('locale', 'ar')->first()->address}}</textarea></th> 
         <td>العنوان (العربية)</td>     
     </tr> 
     <tr>
         
         <td ><textarea class="toggle text-primary in" type="text" name="address_en" required style="width: 100%;">{{$employee->translations()->where('locale', 'en')->first()->address}}</textarea></th> 
     ...
     <tr>
         ...
         <td ><textarea class="toggle text-primary in" type="text" name="job_ar" required style="width: 100%;">{{$employee->translations()->where('locale', 'ar')->first()->job}}</textarea></th>     
         <td>العمل(العربية)</td> 
     </tr>
     <tr>
         
         <td ><textarea class="toggle text-primary in" type="text" name="job_en" required style="width: 100%;">{{$employee->translations()->where('locale', 'en')->first()->job}}</textarea></th>     
 ...
 <div class="modal-content" style="direction:ltr;">
   ...
   <tr>
    ...
    <tr>
        ...
        <td ><textarea class="toggle text-primary in" type="text" name="address_ar" required style="width: 100%; height:26.5px;">{{$employee->translations()->where('locale', 'ar')->first()->address}}</textarea></th> 
        <td>العنوان (العربية)</td>     
    </tr> 
    <tr>
        
        <td ><textarea class="toggle text-primary in" type="text" name="address_en" required style="width: 100%; height:26.5px;">{{$employee->translations()->where('locale', 'en')->first()->address}}</textarea></th> 
        <td>(الانكليزية)العنوان</td>     
    </tr>     
    <tr> 
    ...
    <tr>
        ...
        <td ><textarea class="toggle text-primary in" type="text" name="job_ar" required style="width: 100%; height:26.5px;">{{$employee->translations()->where('locale', 'ar')->first()->job}}</textarea></th>     
        <td>العمل(العربية)</td> 
    </tr>
    <tr>
        
        <td ><textarea class="toggle text-primary in" type="text" name="job_en" required style="width: 100%; height:26.5px;">{{$employee->translations()->where('locale', 'en')->first()->job}}</textarea></th>     
        <td>(الانكليزية)العمل</td> 
    </tr>   
    <tr> 
