                                    ...
                                    <table
                                        ...
                                        @foreach ($permissions as $permission)
                                            <tr>
                                                ...
                                                <td> <label
                                                        for="p_{{ $permission->id }}">{{ $permission->translations()->where('locale', 'ar')->first()->name }}</label>
                                                </td>
                                                <td class="text-center pl-2">
                                                    
                                                    <input @if ($employee->permissions->pluck('id')->contains($permission->id)) checked @endif
