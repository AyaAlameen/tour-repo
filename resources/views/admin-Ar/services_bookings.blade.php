...
<div class="app-content">
    <div class="app-content-header">
      <h1 class="app-content-headerText">حجوزات الخدمات</h1>
      ...
      <div class="app-content-actions-wrapper">
        ...
        <div class="nav-item dropdown" >
                            ...
                            <div class="dropdown-menu border-0 rounded-0 m-0 toggle">
                                <a href="{{route('services_booking_en')}}"  class="dropdown-item">الانكليزية</a>
                                <a href="{{route('services_booking_ar')}}" class="dropdown-item">العربية </a>
