  ...
  <div class="modal-dialog ">
    <div class="modal-content toggle">
      ...
      <div class="modal-footer">
        ...
        <button type="button" onclick="addCategory('add-form')" class="app-content-headerButton">حفظ</button>
      </div>
        ...
        <div class="products-area-wrapper tableView">
            ...
            @foreach( $categories as $category )
                <div class="products-row">
                    ...
                    <div class="product-cell">
                        <img src="{{ asset(str_replace(app_path(),'',$category -> image))}}" alt="product">
                    </div>
                    <div class="product-cell"><button class="app-content-headerButton"><a href="{{route ('sub_category_ar')}}"style="color:var(--title ); text-decoration:none;">التفاصيل</a> </button></div>
                    <div class="product-cell">
                        <!-- start action -->
                        <div class="p-3">
                            <!-- delete -->
