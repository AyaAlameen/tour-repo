...
@section('admincontent')
    <div class="app-content">
        <div class="app-content-header" style="width: 97%;">
                            ...
                            <div class="modal-body">
                                <table style="width: 400px; direction: rtl;"
                                    ...
                                    <tr>
                                        ...
                                        <td> <input type="file" id="add_input_0"  onchange="previewImage(this, 'add_previewImage_0')" name="image" class="toggle text-primary in" name="event_image" required
        ...
        <div class="app-content-actions" style="width: 97%;">
        ...
        <div class="scroll-class" style="width:100%;">
