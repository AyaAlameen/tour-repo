 ...
 <div class="app-content">
      ...
      <div class="app-content-actions-wrapper">
        ...
        <div class="nav-item dropdown" >
                            ...
                            <div class="dropdown-menu border-0 rounded-0 m-0">
                                ...
                                <a href="{{route('booking_en')}}" class="dropdown-item">Arabic </a>
    ...
    <div class="products-area-wrapper tableView">
      <div class="products-header">
        <div class="dropdown" >
                    <a class="dropdown-toggle product-cell text-decoration-none" data-toggle="dropdown">all</a>
                           
                            <div class="dropdown-menu border-0 rounded-0 m-0">
                                <a class="dropdown-item">Events</a>
                                <a class="dropdown-item">Offers</a>
                                <a class="dropdown-item">Places</a>
        ...
        <div class="product-cell">Descount</div>
