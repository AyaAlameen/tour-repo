                    ...
                    <div class="modal-content toggle">
                        ...
                        <div class="modal-body">
                            <table style="color: rgb(22, 22, 22); width: 400px;"
                                ...
                                <tr>
                                    <td>Name(Arabic) </td>
                                    <td><input type="text" class="toggle text-primary in" name="service_name" required
                                            style="width: 100%;"></th>
                                </tr>
                                <tr>
                                    <td>Name(English) </td>
                                ...
                                <tr>
                                    <td>image </td>
                                    <td><input type="file" class="toggle text-primary in" name="service_image" required
                                            style="width: 100%;"></th>
                                </tr>
                                <tr>
                                    <td>Place</td>
                                ...
                                <tr>
                                    <td>Cost</td>
                                    <td><input class="toggle text-primary in" type="text" name="event_cost" required
                                            style="width: 100%;"></th>
                                </tr>
                                <tr>
                                    <td>is_additional</td>
                                    <td>
                                            ...
                                            <label><input type="radio" name="is_additional" value="true">
                                                additional</label>
                                            <label><input type="radio" name="is_additional" value="false"> not additional
                                            </label>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <table class="table-striped table-hover table-bordered m-auto text-primary myTable"
                                        ...
                                        <tr>
                                            <td>Name(Arabic) </td>
                                            <td><input type="text" class="toggle text-primary in" name="service_name"
                                        ...
                                        <tr>
                                            <td>Description(Arabic)</td>
                                            <td><input class="toggle text-primary in" type="text" name="description"
                                                    required style="width: 100%;"></th>
                                        </tr>
                                        <tr>
                                            <td>Description(English)</td>
