                                            ...
                                            <div class="dropdown toggle text-primary in" style="display:inline-block; ;">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <option style="cursor: pointer;" class="dropdown-item"
                                                            id="period_00:15"
                                                            value="00:15"
                                                            onclick="setServiceCount('00:15', 'Quarter Hour')"
                                                            href="#">
                                                            Quarter Hour
                                                        </option>
                                                        <option style="cursor: pointer;" class="dropdown-item"
                                                            id="period_00:30"
                                                            value="00:30"
                                                            onclick="setServiceCount('00:30', 'Half Hour')"
                                                            href="#">
                                                            Half Hour
                                                        </option>
                                                        <option style="cursor: pointer;" class="dropdown-item"
                                                            id="period_01:00"
                                                            value="01:00"
                                                            onclick="setServiceCount('01:00', 'An Hour')"
                                                            href="#">
                                                            An Hour
                                                        </option>
                                                        <option style="cursor: pointer;" class="dropdown-item"
                                                            id="period_02:00"
                                                            value="02:00"
                                                            onclick="setServiceCount('02:00', 'Two Hours')"
                                                            href="#">
                                                            Two Hours
                                                        </option>
                                                        <option style="cursor: pointer;" class="dropdown-item"
                                                            id="period_03:00"
                                                            value="03:00"
                                                            onclick="setServiceCount('03:00', 'Three Hours')"
                                                            href="#">
                                                            Three Hours
                                                        </option>
                                                        <option style="cursor: pointer;" class="dropdown-item"
                                                            id="period_04:00"
                                                            value="04:00"
                                                            onclick="setServiceCount('04:00', 'Four Hours')"
                                                            href="#">
                                                            Four Hours
                                                        </option>
                                                        
                                                    
                                                    <input type="text" id="reservation_period_input" name="reservation_period" hidden>
                        ...
                        <div class="products-row">
                            ...
                            <div class="product-cell">
                                ...
                                <div class="p-3">
                                    ...
                                    <tr @if(!in_array('reservation_period', $service->place->subCategory->additional_fields ?? [])) hidden @endif id="reservation_period_{{$service->id}}">
                                        <td>
                                            <div class="dropdown toggle text-primary in" style="display:inline-block; ;">
                                                ...
                                                @endif
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <option style="cursor: pointer; @if ($service->reservation_period == '00:15') color: #90aaf8 !important; @endif" class="dropdown-item"
                                                         
                                                            id="edit_period_00:15_{{$service->id}}"
                                                            value="00:15"
                                                            onclick="setEditServiceCount('00:15', 'Quarter Hour', {{$service->id}})"
                                                            href="#">
                                                            Quarter Hour
                                                        </option>
                                                        <option style="cursor: pointer; @if ($service->reservation_period == '00:30') color: #90aaf8 !important; @endif" class="dropdown-item"
                                                        ...
                                                        <option style="cursor: pointer; @if ($service->reservation_period == '01:00') color: #90aaf8 !important; @endif" class="dropdown-item"
                                                        ...
                                                        <option style="cursor: pointer;  @if ($service->reservation_period == '02:00') color: #90aaf8 !important; @endif" class="dropdown-item"
                                                        ...
                                                        <option style="cursor: pointer; @if ($service->reservation_period == '03:00') color: #90aaf8 !important; @endif" class="dropdown-item"
                                                        ...
                                                        <option style="cursor: pointer; @if ($service->reservation_period == '04:00') color: #90aaf8 !important; @endif" class="dropdown-item"
                                                    ...
                                                    <input type="text" id="edit_reservation_period_input_{{$service->id}}" value="{{$service->reservation_period}}" name="reservation_period" hidden>
...
<script>
        ...
        $.ajax({
            ...
            .fail(function(data) {
                ...
                if (data.responseJSON.errors.reservation_period) {
                    document.querySelector(`#${formId} #reservation_period_error`).innerHTML = data.responseJSON.errors
    ...
    function editService(formId, id) {
        ...
        $.ajax({
            ...
            .fail(function(data) {
                ...
                if (data.responseJSON.errors.services_count) {
                    document.querySelector(`#${formId} .services_count_error_edit`).innerHTML = data.responseJSON.errors
                        .services_count[0];
                }
                if (data.responseJSON.errors.people_count) {
                    document.querySelector(`#${formId} .people_count_error_edit`).innerHTML = data.responseJSON.errors
                        .people_count[0];
                }
                if (data.responseJSON.errors.reservation_period) {
                    document.querySelector(`#${formId} .reservation_period_error_edit`).innerHTML = data.responseJSON.errors
                        .reservation_period[0];
                }
    ...
    function setEditServiceCount(period_value, option_name, service_id) {
        ...
        document.getElementById(`edit_period_${period_value}_${service_id}`).style.setProperty("color", "#90aaf8", "important");
