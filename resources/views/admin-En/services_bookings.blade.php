                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                            ...
                                                            @foreach ($services as $service)
                                                                <option style="cursor: pointer;"
                                                                    ...
                                                                    value="{{ $service->id }}"
                                                                    id="dservice_{{ $service->id }}"
                                                                    onclick="setService({{ $service->id }}, '{{ $service->translations()->where('locale', 'en')->first()->name }} | {{ $service->cost }}', 'service_{{ $service->id }}', {{ $service->cost }})"
                                                                    href="#">
...
<script>
    ...
    window.onload = (event) => {
        $.ajax({
                url: "{{ route('get_services_booking_en') }}",
                type: "GET",
                processData: false,
                cache: false,
                contentType: false,
