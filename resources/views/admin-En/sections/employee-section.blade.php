        ...
        <div class="products-row">
            ...
            <div class="product-cell">
                ...
                <div class="p-3">
                    ...
                    <!-- Modal -->
                    <div class="modal fade" data-backdrop="static" id="editEmployee{{ $employee->id }}" tabindex="-1"
                                ...
                                <form id="edit-form-{{ $employee->id }}" action="" method="POST"
                                    ...
                                    <div class="modal-body">
                                        <table
                                            ...
                                            <tr>
                                                <td>email</td>
                                                <td><input type="email" name="email" class="toggle text-primary in"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <textarea class="toggle text-primary in" type="text" name="address_ar" required style="width: 100%;"
                                                        value="{{ $employee->translations()->where('locale', 'ar')->first()->address }}"></textarea>
                                                    </th>
                                            </tr>
                                            <tr>
                                                <td>Address(English)</td>
                                                <td>
                                                    <textarea class="toggle text-primary in" type="text" name="address_en" required style="width: 100%;"
                                                        value="{{ $employee->translations()->where('locale', 'en')->first()->address }}"></textarea>
                                                    </th>
                                            </tr>
                                            <tr>
                                                <td>Salary</td>
                                            ...
                                            <tr>
                                                <td>Job(Arabic)</td>
                                                <td>
                                                    <textarea class="toggle text-primary in" type="text" name="job_ar" required style="width: 100%;"
                                                        value="{{ $employee->translations()->where('locale', 'ar')->first()->job }}"></textarea>
                                                    </th>
                                            </tr>
                                            <tr>
                                                <td>job(English)</td>
                                                <td>
                                                    <textarea class="toggle text-primary in" type="text" name="job_en" required style="width: 100%;"
                                                        value="{{ $employee->translations()->where('locale', 'en')->first()->job }}"></textarea>
                                                    </th>
                                            </tr>
                                            <tr>
                                                <td>Identifier</td>
                    ...
                    <div class="modal fade" style="direction:ltr;" data-bs-backdrop="static"
                        ...
                        <div class="modal-dialog" style="max-width:1000px; margin: 5% auto">
                            <div class="modal-content m-auto" style="width:450px;">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalToggleeLabel">Employee permessions </h5>
                                ...
                                <div class="modal-body">
                                    ...
                                    <table style="color: rgb(22, 22, 22); width: 400px !important; "
                                        ...
                                        <tr>
                                            <td> <label for="p1"> emp places permession</label> </td>
                                            <td class="text-center pl-2"><input id="p1" type="checkbox"></td>

                                        </tr>
                                        <tr>
                                            <td> <label for="p2"> Edit salary permession </label> </td>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="app-content-headerButton">Save</button>
                    ...
                    <a class="delete ml-1" title="permessions" data-bs-toggle="modal"
                        href="#exampleModalTogglee"><img src="img/key.png" style="width: 21px; height: 21px;"></a>
                                ...
                                <div class="modal-content m-auto" style="width:450px;">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <table style="color: rgb(22, 22, 22); width: 400px !important; "
                                            ...
                                            <tr>
                                                <td> <label for="p1"> emp places permession</label> </td>
                                                <td class="text-center pl-2"><input id="p1" type="checkbox">
                                                </td>

                                            </tr>
                                            <tr>
                                                <td> <label for="p2"> Edit salary permession </label> </td>
                                                <td class="text-center pl-2"><input id="p2" type="checkbox">
                                                </td>
