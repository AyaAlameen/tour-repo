...
@foreach($employees as $employee)
    ...
    <div class="products-row">
        <button class="cell-more-button">
          ...
          <div class="product-cell">
            <span class="search-value">{{$employee->translations()->where('locale', 'en')->first()->full_name}}</span>
          </div>
          <div class="product-cell">
...
<div class="p-3">
                     ...
                     <a href="#" class="edit p-2" data-toggle="modal" data-target="#editEmployee{{$employee->id}}" title="Edit"><i class="fas fa-pen"></i></a>
                          ...
                          <!-- Modal -->
                     <div class="modal fade" data-backdrop="static" id="editEmployee{{$employee->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                         ...
                         <div class="modal-content">
                           ...
                           <tr>
                            ...
                            <tr>
                                ...
                                <td ><input type="text" class="toggle text-primary in" name="full_name_en" required style="width: 100%;" value="{{$employee->translations()->where('locale', 'en')->first()->full_name}}"></th>      
                            </tr>      
                  ...
                  <tr> 
                         <td>email</td>
                         <td ><input type="email" name="email" class="toggle text-primary in" value="{{$employee -> email}}"></td>  
                           
                  </tr>     
                  <td colspan="2"><span style="color: red" class="email_error_edit"></span></td>
                  <tr> 
                         <td>Phone</td>
                         <td ><input type="number" name="phone" class="toggle text-primary in" value="{{$employee -> phone}}"></td>  
              ...
              <tr>
                  ...
                  <tr> 
                         <td>Salary</td>
                         <td ><input type="number" name="salary" class="toggle text-primary in" value="{{$employee->employeeProfile->salary}}"></td>  
              ...
              <tr>
                  ...
                  <tr> 
                         <td>Identifier</td>
                         <td ><input type="number" name="identifier" class="toggle text-primary in" value="{{$employee->employeeProfile->identifier}}"></td>  
                 ...
                 <div class="modal fade" id="deleteCategory{{$employee->id}}" tabindex="-1" aria-labelledby="exampleModal2Label" aria-hidden="true">
                   <div class="modal-dialog">
                     <div class="modal-content">
                       ...
                       <div class="modal-body">
                         Are you sure that you want to delete This Employee (<span style="color: #EB455F;">{{$employee->translations()->where('locale', 'en')->first()->full_name}}</span>) ?
                       </div>
                       <div class="modal-footer">
