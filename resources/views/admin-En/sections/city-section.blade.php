...
@foreach ($cities as $city)
    @if ($loop->last)
        <div class="products-row">
            ...
            <div class="product-cell">
                <span>{{ $city->translations()->where('locale', 'en')->first()->description }}</span>
            </div>
            <div class="product-cell">
                <button class="app-content-headerButton"><a href="{{ route('getDistrictsEn', ['id' => $city->id]) }}"
            ...
            <div class="product-cell">
                ...
                <div class="p-3">
                    ...
                    <!-- edit -->
                    <a href="#" class="edit text-success m-3" data-toggle="modal"
                        data-target="#editCity{{ $city->id }}" title="Edit"><i class="fas fa-pen"></i></a>

                    <!-- Modal -->
                    <div class="modal fade" data-bs-backdrop="static" id="editCity{{ $city->id }}" tabindex="-1"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form id="edit-form-{{ $city->id }}" action="" method="POST"
                                        ...
                                        <table
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" name="name_ar" class="toggle text-primary in"
                                                        value="{{ $city->translations()->where('locale', 'ar')->first()->name }}">
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" name="name_en" class="toggle text-primary in"
                                                        value="{{ $city->translations()->where('locale', 'en')->first()->name }}">
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="file" name="image" id="img">
                                                    <label for="img"><img
                                                            src="{{ asset(str_replace(app_path(), '', $city->image)) }}"
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" id="edit-city-btn-{{ $city->id }}"
                                        onclick="editCity(`edit-form-{{ $city->id }}`, {{ $city->id }})"
                    ...
                    <a href="#" class="delete" data-toggle="modal"
                        data-target="#deleteCity{{ $city->id }}" title="Delete" data-toggle="tooltip"><i
                    ...
                    <div class="modal fade" id="deleteCity{{ $city->id }}" tabindex="-1"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form id="delete-form-{{ $city->id }}" action="" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <input type="text" name="id" value="{{ $city->id }}" hidden>
                                    <div class="modal-body">
                                        Are you sure that you want to delete This City (<span
                                            style="color: #90aaf8;">{{ $city->translations()->where('locale', 'en')->first()->name }}</span>)
                                        ?
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="action-button active close"
                                            data-dismiss="modal">Close</button>
                                        <button type="submit" id="delete-city-btn-{{ $city->id }}"
                                            onclick="deleteCity(`delete-form-{{ $city->id }}`, {{ $city->id }})"
    ...
    @else
        <div class="products-row">
            ...
            <div class="product-cell">
                <button class="app-content-headerButton"><a
                        href="{{ route('getDistrictsEn', ['id' => $city->id]) }}"
                        style="color:var(--title ); text-decoration:none;">Details</a> </button>
            </div>
            ...
            <div class="product-cell">
                ...
                <div class="p-3">
                    ...
                    <!-- Modal -->
                    <div class="modal fade" data-bs-backdrop="static" id="editCity{{ $city->id }}"
                                ...
                                <form id="edit-form-{{ $city->id }}" action="" method="POST"
                                    ...
                                    <div class="modal-body">
                                        <table
                                            ...
                                            <tr>
                                                <td>Name(Arabic)</td>
                                                <td><input type="text" name="name_ar"
                                            ...
                                            <tr>
                                                <td>Name(English)</td>
                                                <td><input type="text" name="name_en"
                                                        class="toggle text-primary in"
                                                        value="{{ $city->translations()->where('locale', 'en')->first()->name }}">
                                                </td>
