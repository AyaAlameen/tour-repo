        ...
        <div class="products-row">
            ...
            <div class="product-cell">
                ...
                <div class="p-3">
                    ...
                    <!-- Modal -->
                    <div class="modal fade" data-bs-backdrop="static" id="editSubCategory{{ $subCategory->id }}"
                                ...
                                <form id="delete-form-{{ $subCategory->id }}" action="" method="POST"
                                    ...
                                    <div class="modal-body">
                                        Are you sure that you want to delete This sub category (<span
                                            style="color: #90aaf8;">{{ $subCategory->translations()->where('locale', 'en')->first()->name }}</span>)
                                        ?
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="action-button active close"
