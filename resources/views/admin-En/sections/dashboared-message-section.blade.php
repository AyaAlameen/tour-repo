                    ...
                    <div class="d-flex" style="justify-content: space-between;">
                        @if (!$message->seen)
                            <form id="seen-form-{{ $message->id }}" action="" method="POST"
                                ...
                                @csrf
                                <input class="mr-1" name="seen" onclick="seenMessage({{ $message->id }})"
                                    type="checkbox" id="1" />
                                <label class="mr-4" for="1">seen</label>
                            </form>
                        @endif
            ...
            <div class="card w-auto" style="padding-inline:80px; background-color:var(--header);">
                <div class="card-body">
                    ...
                    <div class="d-flex" style="justify-content: space-between;">
                        ...
                        <!-- delete -->
                        <button data-toggle="modal" data-target="#deleteMessage{{ $message->id }}"
                            ata-toggle="tooltip" class="app-content-headerButton">Delete</button>
