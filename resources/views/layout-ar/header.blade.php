 ...
 <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasRight1" aria-labelledby="offcanvasRight1Label">
     <div class="offcanvas-header" style="flex-direction: row-reverse;">
         ...
         <button type="button" id="close_btn_tickets" class="btn-close m-0 close" data-bs-dismiss="offcanvas1"
             aria-label="Close">
             <span aria-hidden="true">&times;</span>
         </button>
     </div>
     <div class="offcanvas-body">
         ...
         <div class="d-flex"
             ...
             <div class="mr-2 text-center" style="position: relative;">
                 ...
                 <h6 style="font-size: 20px; color: #dc3545; cursor: pointer;"><i class="fas fa-cancel">إلغاء الحجز
                     </i></h6>
